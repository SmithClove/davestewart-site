...
export default {
  ...
  methods: {
    ...
    onMouseMove: throttle(100, function (event) {
      const p = pos(event)
    ...
    onMouseLeave () {
      this.stop()
      if (!this.$el.classList.contains('bounce')) {
        this.stop()
      }
    },
